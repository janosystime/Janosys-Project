...
#df_escolas_municipais_privadas['Proporção Municipal'] = ((df_escolas_municipais_privadas['Municipal'] / df_escolas_municipais_privadas['Municipal'].sum())*100).round(2)
#df_escolas_municipais_privadas['Proporção Particular'] = ((df_escolas_municipais_privadas['Particular'] / df_escolas_municipais_privadas['Particular'].sum())*100).round(2)
...
df_escolas_municipais_privadas = pd.read_csv('public/bd/tabela_escolas_publicas_particulares_pop.csv')
...
#    x=categorias,
#    y=y1,
#    name='Proporção de Crianças de 0 a 4 anos',
#    offsetgroup=1,
...
#    x=categorias,
#    y=y3,
#    name='Proporção Particular',
#    offsetgroup=2,
#    base=y2,
#    text=[f"{v:.2f}%" for v in y3],
#    textposition='inside'
#))

#fig.update_layout(
#    barmode='group',
#    title='Proporções por Região',
#    yaxis_title='Proporção (%)',
#v    xaxis_title='Região',
#    plot_bgcolor='white'
#)
